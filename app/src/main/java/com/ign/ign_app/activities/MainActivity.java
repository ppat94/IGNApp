package com.ign.ign_app.activities;
...
import com.ign.ign_app.adapters.PagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] tabIcons = {
            R.drawable.articles_flash_tab_icon,
            R.drawable.videos_play_tab_icon
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                tab.getIcon().setTint(getResources().getColor(R.color.colorTabsText));
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            // Return mFragmentTitleList.get(position); to view tab titles
